                ...
                <div class="row">
                        ...
                        <div class="col-xs-12 col-sm-4">
                                <a class="block block-link-hover3 text-center" href="{{URL::to('purchases/'.$company->id.'/retailer_view')}}">
                                    ...
                                    <div class="block-content block-content-full block-content-mini bg-gray-lighter text-info font-w600">Back to Retailer list</div>
                                </a>
                            </div>
                    </div>
              </div>  
                    ...
                    <div class="col-sm-10 col-sm-offset-1">
                     <div class="block block-bordered">
                                <div class="block-header bg-gray-lighter">
                                    ...
                                    <h3 class="block-title">Add Retailer</h3>
                                </div>
                                <div class="block-content">
                                    <form class="form-horizontal push-10-t push-10" action="{{URL::to('purchases/'.$company->id.'/add_retailer_view')}}" method="post">
                                        <div class="form-group">
                                            <div class="col-xs-6">
                                                <div class="form-material">
                                                    <input class="form-control" type="text" id="register5-firstname" name="retailer-firstname" placeholder="Enter your firstname..">
                                                    <label for="register5-firstname">Firstname</label>
                                                </div>
                                            </div>
                                            <div class="col-xs-6">
                                                <div class="form-material">
                                                    <input class="form-control" type="text" id="register5-lastname" name="retailer-lastname" placeholder="Enter your lastname..">
                                        ...
                                        <div class="form-group">
                                            <div class="col-xs-12">
                                                <div class="form-material">
                                                    <input class="form-control" type="text" id="register5-account" name="retailer-name" placeholder="Retailer's name..">
                                        ...
                                        <div class="form-group">
                                            <div class="col-xs-6">
                                                <div class="form-material input-group">
                                                    <input class="form-control" type="email" id="register5-email" name="retailer-email" placeholder="Enter your email..">
                                            ...
                                            <div class="col-xs-6">
                                                <div class="form-material input-group">
                                                    <input class="form-control" type="number" id="register5-password" name="retailer-contact" placeholder="Enter your contact number..">
