                    ...
                    <div class="col-sm-10 col-sm-offset-1">
                     <div class="block block-bordered">
                                <div class="block-header bg-gray-lighter">
                                    ...
                                    <h3 class="block-title">Edit Product or Service</h3>
                                </div>
                                <div class="block-content">
                                    <form class="form-horizontal push-10-t push-10" action="{{URL::to('purchases/'.$company->id.'/edit_services/'.$service->id)}}" method="post">
                                        <div class="form-group">
                                            <div class="col-xs-8">
                                                <div class="form-material">
                                                    <input class="form-control" type="text" id="register5-firstname" name="services-name" value="{{$service->product_service}}">
                                                    <label for="register5-firstname">Product or Service</label>
                                                </div>
                                            </div>
                                            <div class="col-xs-4">
                                                <div class="form-material">
                                                    <input class="form-control" type="number" id="register5-firstname" name="services-price" value="{{$service->price}}">
                                        ...
                                        <div class="form-group">
                                            <div class="col-xs-12">
                                                <div class="form-material">
                                                    <textarea class="form-control" id="contact2-msg" name="services-description" rows="3">{{$service->product_service_description}}</textarea>
                                            ...
                                            <div class="col-xs-4">
                                                <div class="form-material">
                                                    <select class="form-control" id="contact2-subject" name="services-income" size="1">
                                                        <option value="{{$service->income_account}}">{{$service->income_account}}</option>
                                                        @foreach($income as $i)
                                            ...
                                            <div class="col-xs-4">
                                                <div class="form-material">
                                                    <select class="form-control" id="contact2-subject" name="services-expense" size="1" value="Choose" >
                                                        <option value="{{$service->expense_account}}">{{$service->expense_account}}</option>
                                            ...
                                            <div class="col-xs-4">
                                                <div class="form-material">
                                                    <select class="form-control" id="contact2-subject" name="services-tax" size="1" value="Choose" >
                                                        <option value="{{$service->sales_tax}}">{{$service->sales_tax}}</option>
                                                        @foreach($vats as $v)
