                    ...
                    <div class="row items-push">
                        <div class="col-sm-7">
                            <h1 class="page-heading">
                                Delivery <small>Clean and professional design.</small>
                            </h1>
                        </div>
                        <div class="col-sm-5 text-right hidden-xs">
                            <ol class="breadcrumb push-10-t">
                                <li>Generic</li>
                                <li><a class="link-effect" href="">Delivery</a></li>
                            </ol>
                        </div>
                    </div>
                </div>
                ...
                <div class="content content-boxed">
                    ...
                    <div class="block">
                        <div class="block-header">
                            ...
                            <h3 class="block-title">#DLV0625</h3>
                        </div>
                        <div class="block-content block-content-narrow">
                            <!-- Invoice Info -->
                            <div class="h1 text-center push-30-t push-30 hidden-print">Delivery Receipt</div>
