...
@section('content')
                        ...
                        <div class="block-content">
                            <form class="form-horizontal push-10-t push-10" action="{{URL::to('sales/'.$company->id.'/add_expense_service/'.$order_service->id)}}" method="post" id="formid">
                                <div class="row">
                                    <div class="col-sm-6">
                        ...
                        <h5 style="margin-top: -20px;margin-bottom: 25px;">SPARE PARTS</h5>
                                ...
                                <div class="row">
                                    ...
                                    {{-- <div class="col-xs-2">
                                        <div class="form-material">
                                            <label for="mega-lastname">Total Amount</label>
                                            <input class="form-control input-lg" type="text" id="total-amount" name="total-amount">
                                        </div>
                                    </div> --}}
                                </div>
