                ...
                <div class="content content-boxed">
                    ...
                    <div class="row">
                        ...
                        @if($user->can('add_service'))
                            <a class="block block-link-hover3 text-center" href="{{URL::to('sales/'.$company->id.'/add_spare_part_view')}}">
                                <div class="block-content block-content-full">
                                    <div class="h1 font-w700 text-success"><i class="fa fa-plus"></i></div>
                                </div>
                                <div class="block-content block-content-full block-content-mini bg-gray-lighter text-success font-w600">Add New Spare Part</div>
                            </a>
                        @endif
                        </div>
                        <div class="col-sm-6 col-md-3">
                            <a class="block block-link-hover3 text-center" href="javascript:void(0)">
                                ...
                                <div class="block-content block-content-full block-content-mini bg-gray-lighter text-muted font-w600">All Spare Parts</div>
                            </a>
                        </div>
                    </div>
                    <!-- END Header Tiles -->
                    ...
                    <div class="block">
                        <div class="block-header bg-gray-lighter">
                            ...
                            <h3 class="block-title">All Spare Parts</h3>
                        </div>
                            ...
                            <table class="table table-bordered table-striped js-dataTable-full">
                                <thead>
                                    <tr>
                                        ...
                                        <th class="hidden-xs text-center">Account Name</th>
                                        <th class="hidden-xs text-center">Product</th>
                                        <th class="hidden-xs text-center">Amount</th>
                                        <th class="hidden-xs text-center">Qty</th>
                                ...
                                <tbody>
                                 @foreach($sparepart as $s)
                                    <tr>
                                        <td class="text-center"><strong>{{$s->date}}</strong></td>
