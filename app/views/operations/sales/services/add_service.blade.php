                                    ...
                                    <div class="col-sm-5">
                                        <div class="form-group">
                                            <div class="col-xs-6">
                                                ...
                                                <input class="form-control input-lg" type="number" id="contact_person" name="contact_person" placeholder="Enter Ref. No.">
                                            </div>
                                            <div class="col-xs-4" style="width:200px";>
                                                <label for="mega-lastname">Total</label>
                                                <input class="form-control input-lg" type="number" id="service_total" name="service_total">
                                            </div>
                                        </div>
                                    </div>
                                </div>
