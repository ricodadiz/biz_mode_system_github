...
@section('content')
                                    ...
                                    <div class="product_rows">
                                            ...
                                            <div class="row-line">
                                                <div class="form-group">
                                                    ...
                                                    <div class="col-xs-1">
                                                        <div class="form-material">
                                                            <textarea class="form-control order-vat" name="order-vat[]" rows="1"></textarea>
        ...
        function total_amount(input_obj)
        {
            ...
            var vat = ((row.find('textarea.order-vat').text() != '' && row.find('textarea.order-vat').text() != 0 ) ? parseInt(row.find('textarea.order-vat').text()) : 0);
            var total_amount = 0;
            var amount = 0;
