                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-xs-1">
                                                <div class="form-material">
                                                    ...
                                                    <select class="js-select2 form-control" name="order-vat[]" id="order-vat-0" style="width: 100%;">
                                                        <option selected disabled></option>
                                                        @foreach($vat as $v)
