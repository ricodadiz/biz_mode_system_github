                                        ...
                                        <div class="form-group">
                                            <div class="col-xs-2">
                                                <div class="form-material">
                                                    ...
                                                    <label for="register5-lastname">Status</label>
                                                </div>
                                            </div>
                                            <div class="col-xs-2">
                                                <div class="form-material">
                                            ...
                                            <div class="col-xs-2">
                                                <div class="form-material">
                                                    ...
                                                    <label for="register5-lastname">Terms</label>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            ...
                                            <div class="col-xs-2" style="padding-left: 100px;">
                                                <div class="form-material">
                                                <p>Total:  </p>
                                                <p>Amount Paid:  </p>
                                                </div>
                                            ...
                                            <div class="col-xs-2">
                                                <div class="form-material">
                                                    <input class="form-control" class="form-control" type="text" name="bill-total-amount" id="bill-total-amount"><br>
