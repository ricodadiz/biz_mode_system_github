                        ...
                        <div class="col-sm-6 col-md-3">
                            <a class="block block-link-hover3 text-center" href="javascript:void(0)">
                                <div class="block-content block-content-full">
                                    <div class="h1 font-w700 text-danger" data-toggle="countTo" data-to="{{$technical_issue_count}}"></div>
                                </div>
                                <div class="block-content block-content-full block-content-mini bg-gray-lighter text-danger font-w600">No. of Technical Report</div>
                            </a>
                        </div>
                    ...
                    <div class="block">
                        ...
                        <div class="block-content">
                            <table class="table table-bordered table-striped js-dataTable-full">
                                ...
                                <tbody>
                                @foreach($technical_issue as $tec)
                                    <tr>
                                        <td class="font-w600">{{$tec->user_name}}</td>
                                        <td class="hidden-xs">{{$tec->user_email}}</td>
                                        <td class="hidden-xs">{{$tec->message}}</td>
                                        <td class="hidden-xs">{{$tec->date}}</td>
                                        <td class="hidden-xs">
                                        @if($tec->status == 'Solved')
                                        <span class="label label-success">{{$tec->status}}</span>
                                        @else
                                        <span class="label label-danger">{{$tec->status}}</span>
                                        @endif
                                        </td>
                                        <td class="text-center">
                                            <div class="btn-group">
                                                <a class="btn btn-xs btn-default" data-toggle="modal" data-target="#modal-fadein-{{$tec->id}}" title="View Report Info"><i class="fa fa-eye"></i></a>
                                ...
                                <div class="modal fade" id="modal-fadein-{{$tec->id}}" tabindex="-1" role="dialog" aria-hidden="true">
                                            ...
                                            <div class="modal-content">
                                                <div class="block block-themed block-transparent remove-margin-b">
                                                    <div class="block-header bg-primary-dark">
                                                        ...
                                                        <h3 class="block-title">Technical Report Info</h3>
                                                    </div>
                                    <form id="reply_form{{$tec->id}}" action="{{URL::to('update_technical_report/'.$tec->id)}}" method="post" enctype="multipart/form-data">               
                                                    
                                                    <div class="block-content">
                                                        <div class="form-material">
                                                            <label for="username2">Username </label>
                                                            <input class="form-control" type="text" id="username2" name="username2" value="{{$tec->user_name}}" readonly="readonly">
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="block-content">
                                                        <div class="form-material">
                                                            ...
                                                            <input class="form-control" type="text" id="email2" name="email2" value="{{$tec->user_email}}" >
                                                        </div>
                                                    </div>
                                                        ...
                                                        <div class="row items-push js-gallery">
                                                            <div class="col-sm-6 col-lg-4">
                                                             ...
                                                             {{-- <a class="img-link" href="{{$bus->image}}"> --}}
                                                                <img class="img-responsive" src="{{$tec->image}}" alt="">
                                                             {{-- </a> --}}
                                                            </div>
                                                        </div>
                                                    </div>
                                                    <div class="block-content">
                                                       ...
                                                       <textarea class="form-control input-lg" rows="5" placeholder="Write a reply..." name="reply"></textarea>
                                                    </div>
                                                ...
                                                <div class="modal-footer">
                                                    <button class="btn btn-sm btn-success" type="button" data-dismiss="modal" onclick="$('#reply_form{{$tec->id}}').submit()"><i class="fa fa-envelope-o"></i> Send</button>
                                                </div>
                                    </form>
                                            </div>
                                        </div>
