                        ...
                        <div class="bg-image" style="background-image: url('assets/img/photos/photo6@2x.jpg');">
                            <div class="block-content bg-primary-dark-op text-center overflow-hidden">
                                ...
                                <div class="push-30 animated fadeInUp">
                                    <h2 class="h4 font-w600 text-white push-5">Tiffany Kim</h2>
                                    ...
                                    <ul class="nav-users push">
                                        ...
                                        <li>
                                            <a href="base_pages_profile.html">
                                                ...
                                                <i class="fa fa-circle text-danger"></i> Linda Moore
                                    ...
                                    <ul class="list list-simple">
                                        <li>
                                            <div class="push-5 clearfix">
                                                ...
                                                <a class="font-w600" href="base_pages_profile.html">Eugene Burke</a>
                                        ...
                                        <li>
                                            <div class="push-5 clearfix">
                                                ...
                                                <a class="font-w600" href="base_pages_profile.html">Judy Alvarez</a>
                                                <span class="text-muted">(5/5)</span>
                                            </div>
                                        ...
                                        <li>
                                            <div class="push-5 clearfix">
                                                ...
                                                <a class="font-w600" href="base_pages_profile.html">Ryan Hall</a>
                                                <span class="text-muted">(5/5)</span>
                                            </div>
                                            ...
                                            <ul class="nav-users push">
                                                ...
                                                <li>
                                                    <a href="base_pages_profile.html">
                                                        ...
                                                        <i class="fa fa-circle text-danger"></i> Jeremy Fuller
